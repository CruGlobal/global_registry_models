...
class BaseTest < ActiveSupport::TestCase
  ...
  test '.title' do
    assert_equal 'Test', Entity::Test.title
    assert_equal 'Tests', Entity::Test.title.pluralize
  end

  test '.identifying_attributes' do
    assert_equal [:id], Entity::Test.identifying_attributes
  end

  test '.filterable_attributes' do
    assert_equal [:id, :client_integration_id, :phone, :name], Entity::Test.filterable_attributes
  end
